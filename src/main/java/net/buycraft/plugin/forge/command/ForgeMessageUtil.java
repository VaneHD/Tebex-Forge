...
//            .put("usage_sendlink", "Sends a package or category link to a player.")
    ...
    public static String format(BuycraftPlugin plugin, String message, Object... params) {
        if(plugin.getI18n() != null) return plugin.getI18n().get(message, params);
        else return MessageFormat.format(englishTranslations.getOrDefault(message, message), params);
    }
